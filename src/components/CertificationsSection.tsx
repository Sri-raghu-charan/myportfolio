...
const CertificationsSection: React.FC = () => {
  ...
  const certificates: Certificate[] = [
    ...
    },
    {
      ...
      issuer: 'Talent lad',
      date: 'MAY 2025',
      description: 'Exploration of generative AI technologies, applications, and implementation strategies.',
      skills: ['AI Fundamentals', 'Prompting', 'LLMs and Ai tools', 'Generative Models'],
      credential: 'https://drive.google.com/file/d/14mBygz4l62OaWdYEwUFvFqqzoHRokpJn/view?usp=drivesdk',
    },
     {
      id: 4,
