...
const SkillsSection: React.FC = () => {
  const skills: Skill[] = [
    ...
    { name: 'C', level: 80, category: 'Programming', color: 'bg-indigo-600' },
    { name: 'SQL', level: 75, category: 'Database', color: 'bg-purple-600' },
    { name: 'HTML', level: 45, category: 'Web Development', color: 'bg-orange-600' },
    { name: 'Java', level: 40, category: 'Programming', color: 'bg-red-600' },
    { name: 'Generative AI', level: 70, category: 'Artificial Intelligence', color: 'bg-green-600' },
    { name: 'Problem Solving', level: 80, category: 'Soft Skills', color: 'bg-yellow-600' },
